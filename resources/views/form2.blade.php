...
<section class="h-100 bg-dark">
  <form action="{{route("validation",$var)}}" method="POST">
      @csrf
                            ...
                            <div class="card-body p-md-5 text-black">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-4">
                                        <x-input  name="nom" class="form-outline" input_class="form-control form-control-lg" label_class="form-label" placeholder=" ">
                                            Nom
                                        </x-input>
                                    <!--
                                    ...
                                    <div class="col-md-6 mb-4">
                                        ...
                                        -->
                                        <x-input  name="prenom" class="form-outline" input_class="form-control form-control-lg" label_class="form-label" placeholder=" ">
                                            Prenom
                                        </x-input>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-4">
                                        <x-input  name="nom_entreprise" class="form-outline" input_class="form-control form-control-lg" label_class="form-label" placeholder=" ">
                                            Nom de l'entreprise
                                        </x-input>
                                        <!--
                                        <div class="form-outline">
                                    ...
                                    <div class="col-md-6 mb-4">
                                        <x-input  name="num_tel" class="form-outline" input_class="form-control form-control-lg" label_class="form-label" placeholder=" ">
                                            Numero de telephone
                                        </x-input>
                                        <!--
                                ...
                                <div class="form-outline">
                                  ...
                                  -->
                                <x-input  name="adresse" class="form-outline" input_class="form-control form-control-lg" label_class="form-label" placeholder=" ">
                                    Adresse
                                </x-input>
                                <!--
                                <div class="form-outline mb-4">
                                 ...
                                 -->
                                <x-input  name="adresse_email" class="form-outline" input_class="form-control form-control-lg" label_class="form-label" placeholder=" ">
                                    Adresse Email
                                </x-input>
...
-->
                                <x-input  name="commentaire" class="form-outline" input_class="form-control form-control-lg" label_class="form-label" placeholder=" ">
                                    Commentaire
                                </x-input>
                                ...
                                <div class="container mt-5">
                                    <div class="input-group">
                                        ...
                                        @if($var=="small"|| $var=="large" || $var=="medium")
...
<script>
    ...
    const vpsOption ="{{$var}}"; //small or large or medium or vps or serveurs
